...
| Post-SWITCH_OVER crash (180° wrong-angle) | **Ongoing** |

**Root cause of ongoing issue:**
At phase 5 exit (6A, 1700 RPM): BEMF = 0.425 V, Rs×I = 0.600 V → **SNR = 0.71** (< 1.0).
The STO observer consistently locks to the 180° wrong-angle solution → motor enters RUN
with inverted flux angle → erratic motion → ANY_STOP.

**Proposed next iteration:**
- PHASE5_FINAL_CURRENT_A: 6.0 → **4.0 A**
- PHASE5_FINAL_SPEED: 1700 → **1600 RPM**
...
Risk: HOSIM motor may not sustain 1600 RPM at 4A under drivetrain load (latest rosbag
shows speed plateau at 1602–1668 RPM at 6A — margin is tight).
...
| HOSIM current | 6 A | 1700 | 0.425 V | 0.600 V | 0.71 | ✗ |
| HOSIM proposed | 4 A | 1600 | 0.400 V | 0.400 V | 1.00 | ? |
